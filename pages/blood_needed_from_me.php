...
$sql = "SELECT br.*, u.username AS recipient_name
        FROM blood_request br
        LEFT JOIN user u ON br.recipient_id = u.id
        WHERE br.donor_id = ?";
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    <td><?php echo $row['recipient_id'] == 0 ? 'Any' : htmlspecialchars($row['recipient_name']); ?></td>
